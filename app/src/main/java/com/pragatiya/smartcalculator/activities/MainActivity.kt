...
import com.pragatiya.smartcalculator.calculator.Calculator
import com.pragatiya.smartcalculator.calculator.division_by_0
import com.pragatiya.smartcalculator.calculator.domain_error
import com.pragatiya.smartcalculator.calculator.is_infinity
import com.pragatiya.smartcalculator.calculator.parser.Expression
...
import com.pragatiya.smartcalculator.calculator.parser.NumberingSystem.Companion.toNumberingSystem
import com.pragatiya.smartcalculator.calculator.require_real_number
import com.pragatiya.smartcalculator.calculator.syntax_error
...
class MainActivity : AppCompatActivity() {
    ...
    fun addButton(view: View) {
        if (clickCount > 10){
            AdManager(this@MainActivity).loadInterstitialAd()
            clickCount = 0
        } else {
            clickCount++
        }
    ...
    override fun onResume() {
        ...
        AdManager(this).loadNativeAd(binding.nativeSmall, AdLayoutType.SMALL)
